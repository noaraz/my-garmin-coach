...
- [x] Upgrade garminconnect to 0.3.x, pin garth 0.5.x
- [x] Create GarminAdapterProtocol + unified exception hierarchy
- [x] Add SystemConfig table + admin endpoint for runtime flag switching
- [x] Rename adapter.py → adapter_v1.py with exception wrapping
- [x] Create GarminAdapterV2 (garminconnect 0.3.x native)
- [x] Update client_factory.py with V2 paths + factory branching
- [x] Create WorkoutFacade (version-aware formatter bridge)
- [x] Migrate consumers (sync.py, garmin_connect.py, auto_reconnect.py)
- [x] Update test mocks for unified exceptions
- [x] Full verification + docs
