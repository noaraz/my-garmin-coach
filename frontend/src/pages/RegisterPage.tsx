    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-main)' }}>
      <div style={{ width: '100%', maxWidth: '380px', padding: '0 16px' }}>
        ...
        <div style={{ background: 'var(--bg-surface)', border: '1px solid var(--border)', borderRadius: '10px', padding: '28px 24px' }}>
          <h1 style={{ fontFamily: "'IBM Plex Sans Condensed', system-ui, sans-serif", fontWeight: 700, fontSize: '20px', letterSpacing: '0.06em', textTransform: 'uppercase' as const, color: 'var(--text-primary)', margin: '0 0 6px' }}>Request Access</h1>
          <p style={{ fontSize: '13px', color: 'var(--text-secondary)', fontFamily: "'IBM Plex Sans', system-ui, sans-serif", margin: '0 0 20px' }}>Sign in with Google to create your account</p>

          {inviteCode && (
            <p style={{ fontSize: '11px', color: 'var(--text-muted)', fontFamily: "'IBM Plex Mono', monospace", margin: '0 0 14px' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '16px', fontSize: '12px', color: 'var(--text-muted)', fontFamily: "'IBM Plex Sans', system-ui, sans-serif" }}>
