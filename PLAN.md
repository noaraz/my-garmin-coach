...
| — | Completed Workout Description | `features/calendar/` | calendar | ✅ |
...
Completed Workout Description: shows `template.description` on all workout surfaces (cards, detail panel, mobile, Today page) — even after a Garmin activity is matched. Design spec: `docs/superpowers/specs/2026-03-23-completed-workout-description-design.md`
